        ...
        <div class="w-100 d-flex justify-content-between">
            <div>
                ...
                <a class="navbar-sm-brand text-light text-decoration-none"
                    href="mailto:abdoalkhabet556@gmail.com">abdoalkhabet556@gmail.com</a>
                <i class="fa fa-phone mx-2"></i>
                <a class="navbar-sm-brand text-light text-decoration-none" href="tel:010-019-10725">01001910725</a>
            </div>
            <div>
        ...
        <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
            ...
            <div class="navbar align-self-center d-flex">
                ...
                <?php
                        if (!empty($_SESSION['user'])){?>
                <a class="nav-icon position-relative text-decoration-none" href="#">
                    <a href="userprof.php"> <i class="fa fa-fw fa-user text-dark mr-3"></i></a>
                </a>
                <a class="nav-icon position-relative text-decoration-none" href="#">
